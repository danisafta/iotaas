...
Future<List<NodeDetails>> fetchChartDetails() async {
...
class _MyChartState extends State<MyChart> {
  late Future<List<NodeDetails>> futureChartDetails;

  @override
  void initState() {
    super.initState();
    futureChartDetails = fetchChartDetails();
  }
