...
class NodeAppsDetails extends StatefulWidget {
  NodeAppsDetails({Key? key}) : super(key: key);

  @override
  _NodeAppsDetailsState createState() => _NodeAppsDetailsState();
}

class _NodeAppsDetailsState extends State<NodeAppsDetails> {
